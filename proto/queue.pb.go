...
type QueueInfo struct {
	...
	// The namespace this queue belongs to. Used for multi-tenant isolation.
	// If empty, the queue belongs to the default namespace.
...
func (x *QueueInfo) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
type QueueReloadRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The name of the queue to reload
	QueueName string `protobuf:"bytes,1,opt,name=queueName,json=queue_name,proto3" json:"queueName,omitempty"`
}

func (x *QueueReloadRequest) Reset() {
	*x = QueueReloadRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueueReloadRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueueReloadRequest) ProtoMessage() {}

func (x *QueueReloadRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_queue_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueueReloadRequest.ProtoReflect.Descriptor instead.
func (*QueueReloadRequest) Descriptor() ([]byte, []int) {
	return file_proto_queue_proto_rawDescGZIP(), []int{14}
}

func (x *QueueReloadRequest) GetQueueName() string {
	if x != nil {
		return x.QueueName
	}
	return ""
...
type QueueReloadResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *QueueReloadResponse) Reset() {
	*x = QueueReloadResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueueReloadResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueueReloadResponse) ProtoMessage() {}

func (x *QueueReloadResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_queue_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueueReloadResponse.ProtoReflect.Descriptor instead.
func (*QueueReloadResponse) Descriptor() ([]byte, []int) {
	return file_proto_queue_proto_rawDescGZIP(), []int{15}
}

func (x *QueueReloadResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *QueueReloadResponse) GetCodeText() string {
	if x != nil {
		return x.CodeText
	}
	return ""
...
func (x *QueueReloadResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type QueuePartitionStats struct {
	...
	Scheduled int32 `protobuf:"varint,7,opt,name=scheduled,proto3" json:"scheduled,omitempty"`
	// UnLeased is the count of un-leased items the Logical believes are available in the partition,
	// sourced from in-memory state. Pairs with the storage-derived total; divergence indicates
	// in-memory accounting drift.
	UnLeased int32 `protobuf:"varint,8,opt,name=unLeased,json=un_leased,proto3" json:"unLeased,omitempty"`
	// NextLifecycleRun is the duration until the partition's lifecycle/GC routine next runs,
	// sourced from in-memory state. Exposes GC cadence and the expiry-scheduling the dead-letter
	// path must advance.
	NextLifecycleRun string `protobuf:"bytes,9,opt,name=nextLifecycleRun,json=next_lifecycle_run,proto3" json:"nextLifecycleRun,omitempty"`
}
...
func (x *QueuePartitionStats) GetScheduled() int32 {
	if x != nil {
		return x.Scheduled
	}
	return 0
...
func (x *QueuePartitionStats) GetUnLeased() int32 {
	if x != nil {
		return x.UnLeased
	}
	return 0
...
func (x *QueuePartitionStats) GetNextLifecycleRun() string {
	if x != nil {
		return x.NextLifecycleRun
	}
	return ""
}
...
var file_proto_queue_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xd6, 0x03, 0x0a, 0x09, 0x51, 0x75, 0x65, 0x75, 0x65, 0x49,
	...
	,
	...
	0x67, 0x69, 0x63, 0x61, 0x6c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x73, 0x22, 0xc0, 0x02, 0x0a, 0x13,
	...
	,
...
var file_proto_queue_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_proto_queue_proto_goTypes = []interface{}{
	...
	(*QueueReloadRequest)(nil),    // 14: querator.QueueReloadRequest
	(*QueueReloadResponse)(nil),   // 15: querator.QueueReloadResponse
	(*QueueStatsRequest)(nil),     // 16: querator.QueueStatsRequest
	(*QueueStatsResponse)(nil),    // 17: querator.QueueStatsResponse
	(*QueuePartitionStats)(nil),   // 18: querator.QueuePartitionStats
	(*QueueLogicalStats)(nil),     // 19: querator.QueueLogicalStats
...
var file_proto_queue_proto_depIdxs = []int32{
	...
	20, // 1: querator.QueueProduceItem.enqueueAt:type_name -> google.protobuf.Timestamp
	20, // 2: querator.QueueLeaseItem.leaseDeadline:type_name -> google.protobuf.Timestamp
	...
	20, // 5: querator.QueueRetryItem.retryAt:type_name -> google.protobuf.Timestamp
	20, // 6: querator.QueueInfo.createdAt:type_name -> google.protobuf.Timestamp
	20, // 7: querator.QueueInfo.updatedAt:type_name -> google.protobuf.Timestamp
	12, // 8: querator.QueueInfo.partitions:type_name -> querator.PartitionInfo
	19, // 9: querator.QueueStatsResponse.logicalQueues:type_name -> querator.QueueLogicalStats
	18, // 10: querator.QueueLogicalStats.partitions:type_name -> querator.QueuePartitionStats
...
func file_proto_queue_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_queue_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueueReloadRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_queue_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueueReloadResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_queue_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_queue_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
